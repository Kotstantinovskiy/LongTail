...
public class TF_IDF_bigramm extends Configured implements Tool {
    ...
    public static class TFIDFMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        ...
        protected void setup(Mapper.Context context) throws IOException {
            Path docs_df = new Path(Config.DOCS_ALL_IDF_BI);
    ...
    public static void main(String[] args) throws Exception{
        int exitCode = ToolRunner.run(new TF_IDF_bigramm(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TF_IDF_bigramm");

        job.setJarByClass(TF_IDF_bigramm.class);
